...
class D < Formula
    ...
    url "https://github.com/dezhaoli/d/archive/v3.1.8.tar.gz", :using => GitHubPrivateRepositoryDownloadStrategy

    if OS.mac?
      sha256 "1b9ec1410c04e5f1b15c60ed44dd9429165f7c766d391e6d4ee774be36c61a9c"
    end
