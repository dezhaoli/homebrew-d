...
class D < Formula
    ...
    url "https://github.com/dezhaoli/d/archive/v3.1.9.tar.gz", :using => GitHubPrivateRepositoryDownloadStrategy

    if OS.mac?
      sha256 "bfaf65d932ac5878ba1333a8b48fb2b8079cc03ac158c5a7c985f220febc3477"
    end
