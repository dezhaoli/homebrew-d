...
class D < Formula
    ...
    url "https://github.com/dezhaoli/d/archive/v3.1.7.tar.gz", :using => GitHubPrivateRepositoryDownloadStrategy

    if OS.mac?
      sha256 "0ddb7f7daa4b3e8dc0c7ee8d9a81f83fcecc652ed6e4a5c105810a9f43bb287d"
    end
