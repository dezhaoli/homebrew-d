...
class D < Formula
    ...
    url "https://github.com/dezhaoli/d/archive/v3.1.6.tar.gz", :using => GitHubPrivateRepositoryDownloadStrategy

    if OS.mac?
      sha256 "80612b90bd44043b13f5c1227acb2d00c8935c173a8098971ac132e1d0c3d70b"
    end
